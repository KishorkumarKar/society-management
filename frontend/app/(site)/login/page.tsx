...
export const metadata: Metadata = {
  ...
  description: "Sign in to your society's noticeboard, ledger, or admin console.",
};
        ...
        <div className="w-full max-w-md">
          <div className="mb-8 flex flex-col items-center gap-2 text-center">
            ...
            <p className="text-sm text-paper/60">
              ...
              Admins and the super admin are routed to the management console automatically.
            </p>
          </div>
          <Card className="p-8">
            <LoginForm />
